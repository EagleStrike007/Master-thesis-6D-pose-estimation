...
This thesis was written to graduate from the joint program Industrial Engineering Technology offered by [KU Leuven](https://www.kuleuven.be/kuleuven) and [UHasselt](https://www.uhasselt.be/nl). The thesis was carried out in collaboration with KU Leuven research group [ACRO](https://iiw.kuleuven.be/onderzoek/acro).
